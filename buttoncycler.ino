...
#define PIXEL_PIN    6  // Digital IO pin connected to the NeoPixels.//输出脚

#define PIXEL_COUNT 60  // Number of NeoPixel//灯珠数量
...
unsigned char pid[] = {"8j0tamu16f6tex1r"};//*********处替换成涂鸦IoT平台自己创建的产品的PID
